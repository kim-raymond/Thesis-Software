...
export default function ({logIn, setLogIn}:LogInProps){
    ...
    return(
        <div className={` ${logIn ? 'hidden':''} w-full h-screen bg-logIn bg-contain flex flex-col items-center justify-center gap-[1.2rem] relative`}>
            ...
            <div className="flex flex-col gap-[2.2rem] w-[14rem] text-center text-stone-800">
                <div className='flex items-center gap-[0.2rem] justify-center'>
                    <div className='bg-logo bg-cover bg-center bg-no-repeat w-[4.5rem] h-[3rem]'></div>
            ...
            <button type='submit' onClick={changeLoginStat} className="w-full bg-green-800 hover:bg-green-600 py-2.5 font-bold rounded-[20rem] hover:cursor-pointer">LOGIN</button>
            </div>
            
            <div className='text-stone-700 w-[18rem] h-full bg-center bg-cover bg-no-repeat bg-nmmc gap-[2rem] rounded-r-[2rem] bg-stone-100'>
